...
export class GalleryPage {
  ...
  categories = [
    ...
    { id: 'ot', label: 'Operation Theatres' },
  ...
  items: GalleryItem[] = [
    ...
    { src: '/image-26-gallery (1).webp', title: 'X-Ray Room', category: 'X-Ray' },
    ...
    { src: '/image-15-gallery.webp', title: 'NABH Accreditation', category: 'diagnostics' },
    { src: '/image-16-gallery.webp', title: 'Neonatal Intensive Care Unit', category: 'diagnostics' },    
    { src: '/Nicu-picu.webp', title: 'NICU & PICU', category: 'specialty' },
    { src: '/image-19-gallery.webp', title: 'Pathology Lab', category: 'specialty' },  
    { src: '/image-17-gallery.webp', title: 'Eye Examination Room', category: 'specialty' },
    { src: '/image-22-gallery.webp', title: 'Ultrasound Room', category: 'specialty' },
    ...
    { src: '/image-27-gallery.webp', title: 'MRI / CT Suite', category: 'team' },
    { src: '/image-28-gallery.webp', title: 'Emergency Room', category: 'team' },
  ];
